                ...
                <blockquote className="text-center lg:mx-auto lg:w-3/5">
                    ...
                    <div className="mt-6 lg:mt-10">
                        <p className="relative text-xl sm:text-2xl md:text-3xl md:leading-normal font-medium text-gray-800">
                            <svg className="absolute top-0 start-0 transform -translate-x-8 -translate-y-8 size-16 sm:h-24 sm:w-24 text-neutral-700" width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                    ...
                    <footer className="mt-6">
                        <div className="font-semibold text-neutral-200">- {quote.author}</div>
                    </footer>
                </blockquote>
            </div>
        </>
